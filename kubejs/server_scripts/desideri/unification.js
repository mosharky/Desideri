...
InputOutputReplace.push(
    ...
    // { condition: {}, toReplace: 'malum:copper_nugget', replaceWith: 'immersiveengineering:nugget_copper' },
    // { condition: {}, toReplace: 'immersiveengineering:dust_sulfur', replaceWith: 'thermal:sulfur_dust' },
    // { condition: {}, toReplace: 'immersiveengineering:dust_wood', replaceWith: 'thermal:sawdust' },
    // { condition: {}, toReplace: 'immersiveengineering:slag', replaceWith: 'thermal:slag' },
)
...
regexFullRemovals.push(
    ...
    // /immersiveengineering:(?!dust|plate).*lead.*/,
    // /immersiveengineering:.*_silver/, // underscore is there because i dont want to delete the bullet
    // /immersiveengineering:(?!wire).*electrum.*/,
...
addTagToItem.push(
    ...
    { tag: 'forge:storage_blocks/copper', item: 'oreganized:lead_block' },
)

// json override for deleted thermal seeds
onEvent('server.datapack.high_priority', (event) => {
    event.addJson('thermal:loot_modifiers/seeds_from_grass.json', {
        type: 'thermal:seeds_from_grass',
        conditions: [
            {
...
onEvent('recipes', event => {
    ...
    event.custom({
        ...
        inputs: [
            ...
            { tag: 'forge:gunpowder' },
            {
                base_ingredient: { tag: 'forge:nuggets/invar' },
                count: 2
            },
            {
